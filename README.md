...
</td><td><a href="#changeseparatornon-empty-string-separator-this">changeSeparator</a>
...
</td></tr><tr><td><a href="#static-createmixed-data-string-iteratorclass-bool-checkpropertiesinconstructor-static">create</a>
</td><td><a href="#createbyreferencearray-array-this">createByReference</a>
</td><td><a href="#static-createfromarrayarray-array-static">createFromArray</a>
</td><td><a href="#static-createfromgeneratorfunctioncallable-generatorfunction-static">createFromGeneratorFunction</a>
</td></tr><tr><td><a href="#static-createfromgeneratorimmutablegenerator-generator-static">createFromGeneratorImmutable</a>
</td><td><a href="#static-createfromjsonstring-json-static">createFromJson</a>
</td><td><a href="#static-createfromjsonmapperstring-json-static">createFromJsonMapper</a>
</td><td><a href="#static-createfromobjecttraversable-object-static">createFromObject</a>
</td></tr><tr><td><a href="#static-createfromobjectvarsobject-object-static">createFromObjectVars</a>
</td><td><a href="#static-createfromstringstring-str-non-empty-stringnull-delimiter-stringnull-regex-static">createFromString</a>
</td><td><a href="#static-createfromtraversableimmutabletraversable-traversable-bool-use_keys-static">createFromTraversableImmutable</a>
</td><td><a href="#static-createwithrangefloatintstring-low-floatintstring-high-floatint-step-static">createWithRange</a>
...
</td><td><a href="#findkeyclosure-closure-falseintstring">findKey</a>
</td><td><a href="#first-mixednull">first</a>
</td><td><a href="#firstkey-mixednull">firstKey</a>
</td></tr><tr><td><a href="#firstsimmutableintnull-number-static">firstsImmutable</a>
...
</td></tr><tr><td><a href="#flip-static">flip</a>
...
</td></tr><tr><td><a href="#getarraycopy-array">getArrayCopy</a>
</td><td><a href="#getbackwardsgenerator-generator">getBackwardsGenerator</a>
...
</td><td><a href="#getiterator-iteratormixed-mixed">getIterator</a>
...
</td><td><a href="#getphpdocpropertiesfromclass-arrayarray-key-typecheckinterfacetypecheckarrayarray-key-typecheckinterface">getPhpDocPropertiesFromClass</a>
...
</td><td><a href="#static-meta-arrayymetamixedstatic">meta</a>
...
</td><td><a href="#partitionclosure-closure-arrayint-static">partition</a>
...
</td></tr><tr><td><a href="#rsortimmutableint-sort_flags-this">rsortImmutable</a>
...
</td></tr><tr><td><a href="#setstring-key-mixed-value-this">set</a>
...
</td></tr><tr><td><a href="#shift-mixednull">shift</a>
...
</td></tr><tr><td><a href="#sizeisbetweenint-fromsize-int-tosize-bool">sizeIsBetween</a>
...
</td></tr><tr><td><a href="#sliceint-offset-intnull-length-bool-preservekeys-static">slice</a>
...
</td></tr><tr><td><a href="#sortkeysimmutableintstring-direction-int-strategy-this">sortKeysImmutable</a>
...
</td></tr><tr><td><a href="#spliceint-offset-intnull-length-array-replacement-static">splice</a>
...
</td></tr><tr><td><a href="#toarraybool-convertallarrayyelements-bool-preservekeys-array">toArray</a>
...
</td></tr><tr><td><a href="#tostringstring-separator-string">toString</a>
...
</td></tr><tr><td><a href="#uksortimmutablecallable-callable-static">uksortImmutable</a>
...
</td></tr><tr><td><a href="#unserializestring-string-this">unserialize</a>
...
</td></tr><tr><td><a href="#walkcallable-callable-bool-recursive-mixed-userdata-this">walk</a>
...
## changeSeparator(non-empty-string $separator): $this
<a href="#voku-php-readme-class-methods">↑</a>
...
## static create(mixed $data, string $iteratorClass, bool $checkPropertiesInConstructor): static
<a href="#voku-php-readme-class-methods">↑</a>
Creates an Arrayy object.
...
## static createFromArray(array $array): static
<a href="#voku-php-readme-class-methods">↑</a>
Create an new Arrayy object via JSON.
...
## static createFromGeneratorFunction(callable $generatorFunction): static
<a href="#voku-php-readme-class-methods">↑</a>
...
## static createFromGeneratorImmutable(\Generator $generator): static
<a href="#voku-php-readme-class-methods">↑</a>
Create an new instance filled with a copy of values from a "Generator"-object.
...
## static createFromJson(string $json): static
<a href="#voku-php-readme-class-methods">↑</a>
Create an new Arrayy object via JSON.
...
## static createFromJsonMapper(string $json): static
<a href="#voku-php-readme-class-methods">↑</a>
...
## static createFromObject(\Traversable $object): static
<a href="#voku-php-readme-class-methods">↑</a>
...
## static createFromObjectVars(object $object): static
<a href="#voku-php-readme-class-methods">↑</a>
Create an new instance filled with values from an object.
...
## static createFromString(string $str, non-empty-string|null $delimiter, string|null $regEx): static
<a href="#voku-php-readme-class-methods">↑</a>
Create an new Arrayy object via string.
...
## static createFromTraversableImmutable(\Traversable $traversable, bool $use_keys): static
<a href="#voku-php-readme-class-methods">↑</a>
Create an new instance filled with a copy of values from a "Traversable"-object.

**Parameters:**
- `\Traversable $traversable`
- `bool $use_keys [optional] <p> Whether to use the iterator element keys as index. </p>`
...
## static createWithRange(float|int|string $low, float|int|string $high, float|int $step): static
<a href="#voku-php-readme-class-methods">↑</a>
Create an new instance containing a range of elements.
...
**Parameters:**
- `array $array`
- `array|\Generator|null $helperVariableForRecursion <p>(only for internal usage)</p>`
...
**Parameters:**
- `\Closure|null $closure [optional] <p> The callback function to use </p> <p> If no callback is supplied, all entries of input equal to false (see converting to boolean) will be removed. </p>`
- `int $flag [optional] <p> Flag determining what arguments are sent to <i>callback</i>: </p> <ul> <li> <b>ARRAY_FILTER_USE_KEY</b> (1) - pass key as the only argument to <i>callback</i> instead of the value </li> <li> <b>ARRAY_FILTER_USE_BOTH</b> (2) - pass both value and key as arguments to <i>callback</i> instead of the value </li> </ul>`
...
- `string $property`
- `mixed $value`
- `string|null $comparisonOp <p> 'eq' (equals),<br /> 'gt' (greater),<br /> 'gte' || 'ge' (greater or equals),<br /> 'lt' (less),<br /> 'lte' || 'le' (less or equals),<br /> 'ne' (not equals),<br /> 'contains',<br /> 'notContains',<br /> 'newer' (via strtotime),<br /> 'older' (via strtotime),<br /> </p>`
...
## findKey(\Closure $closure): false|int|string
<a href="#voku-php-readme-class-methods">↑</a>
...
**Parameters:**
- `int|string $key <p>The key to look for.</p>`
...
- `bool $preserveKeys <p> e.g.: A generator maybe return the same key more than once, so maybe you will ignore the keys. </p>`
...
**Parameters:**
- `callable|int|string $grouper <p>A callable function name.</p>`
- `bool $saveKeys`
...
**Parameters:**
- `bool $recursive [optional] <p> Get all keys, also from all sub-arrays from an multi-dimensional array. </p>`
- `mixed|null $search_values [optional] <p> If specified, then only keys containing these values are returned. </p>`
- `bool $strict [optional] <p> Determines if strict comparison (===) should be used during the search. </p>`
...
**Parameters:**
- `string $key <p>The key to set.</p>`
- `mixed $value <p>Its value.</p>`
...
- `mixed $userData [optional] <p> If the optional $userData parameter is supplied, it will be passed as the third parameter to the $callable. </p>`
