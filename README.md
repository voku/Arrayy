...
</td><td><a href="#randomweightedarray-array-nullint-number">randomWeighted</a>
...
**Parameters:**
- `null|\Closure(T, TKey=): bool|\Closure(T): bool|\Closure(TKey): bool $closure [optional] <p>
...
## randomWeighted(array $array, null|int $number): 
<a href="#voku-php-readme-class-methods">↑</a>
