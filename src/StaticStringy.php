 ...
 * @method static array  lines(string $stringInput, string $encoding = null)
 ...
 * @method static array  split(string $stringInput, string $pattern, int $limit = null, string $encoding = null)
