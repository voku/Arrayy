 ...
 * @method static string replace(string $stringInput, string $search, string $replacement, bool $caseSensitive, string $encoding = null)
 * @method static string replaceAll(string $stringInput, array $search, string $replacement, bool $caseSensitive, string $encoding = null)
