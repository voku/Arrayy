...
final class ArrayyTest extends \PHPUnit\Framework\TestCase
{
     ...
     * @param mixed $actual
     */
    public static function assertArrayy($actual): void
    {
    ...
    public function testAdd(): void
    {
        ...
        self::assertMutable($arrayy, $resultArrayy, $array); // @phpstan-ignore-line argument.type (the runtime API intentionally accepts or transforms a value PHPStan cannot reconcile with the invariant template)
    }

    public function testAppendImmutableYield(): void
    {
        $array = [1, 2];
        $arrayy = new A($array);
        ...
        self::assertImmutable($arrayy, $resultArrayy, $array, $arrayResult); // @phpstan-ignore-line argument.type (the runtime API intentionally accepts or transforms a value PHPStan cannot reconcile with the invariant template)
    }

    public function testPrependImmutableYield(): void
    {
        $array = [3 => 1, 2];
        $arrayy = new A($array);
     ...
     */
    public function testAverage($array, $value, $expected): void
    {
        $arrayy = new A($array);
    ...
    public function testCanGetIntersectionOfTwoArraysKeepKeys(): void
    {
        $a = ['foo', 'bar'];
        $b = ['bar', 'baz'];
    ...
    public function testCanGroupValuesWithSavingKeysViaYield(): void
    {
        $grouper = static function ($value, $key) {
            return (int) ($value % 2 === 0);
        };
    ...
    public function testCanIndexByViaYield(): void
    {
        $array = [
            ['name' => 'moe', 'age' => 40],
            ['name' => 'larry', 'age' => 50],
    ...
    public function testChunk(array $array): void
    {
        ...
        self::assertImmutable($arrayy, $resultArrayy, $array, $resultArray); // @phpstan-ignore-line argument.type (the runtime API intentionally accepts or transforms a value PHPStan cannot reconcile with the invariant template)
    ...
    public function testCompareToPhpArray(): void
    {
        $initArray = [
            'fruit' => [
                'orange',
     ...
     * @param bool  $expected
     */
    public function testContainsOnly($array, $value, $expected): void
    {
        $arrayy = new A($array);
     ...
     * @param bool  $expected
     */
    public function testContains($array, $value, $expected): void
    {
        $arrayy = new A($array);
     ...
     * @param bool  $expected
     */
    public function testContainsCaseInsensitive($array, $value, $expected): void
    {
        $arrayy = new A($array);
     ...
     * @param bool  $expected
     */
    public function testContainsCaseInsensitiveRecursive($array, $value, $expected): void
    {
        $arrayy = new A($array);
    ...
    public function testContainsKeysRecursive(): void
    {
     ...
     * @param bool  $expected
     */
    public function testContainsRecursive($array, $value, $expected): void
    {
        $arrayy = new A($array);
    ...
    public function testContainsValues(): void
    {
    ...
    public function testCreateFromJsonApiResponse(): void
    {
        $str = '
        {
            "type": "person",
     ...
     */
    public function testCreateFromString($string, $separator): void
    {
        if ($separator !== null) {
        ...
        \assert(\is_array($array)); // @phpstan-ignore-line function.alreadyNarrowedType (the runtime guard is retained for inputs from supported PHP versions and data providers)

        $arrayy = new A($array);

        $resultArrayy = A::createFromString($string, $separator);

        self::assertImmutable($arrayy, $resultArrayy, $array, $array); // @phpstan-ignore-line argument.type (the runtime API intentionally accepts or transforms a value PHPStan cannot reconcile with the invariant template)
    }

    public function testCreateFromTraversableImmutable(): void
    {
    ...
    public function testCreateFromStringRegEx(): void
    {
        $str = '
    ...
    public function testCreateFromStringSimple(): void
    {
    ...
    public function testCreateWithRange(): void
    {
    ...
    public function testCustomSortKeysSimple(): void
    {
        $callable = static function ($a, $b) {
            if ($a === $b) {
                return 0;
        ...
        static::assertSame($expected, $resultArrayy->getArray());
        self::assertImmutable($arrayy, $resultArrayy, $input, $resultArrayy->getArray()); // @phpstan-ignore-line argument.type (the runtime API intentionally accepts or transforms a value PHPStan cannot reconcile with the invariant template)
    }

    public function testCustomSortValuesByDateTimeObject(): void
    {
        $birthDates = [
        ...
        $thisYear = $resultMatch['thisYear']->customSortValues($closureSort); // @phpstan-ignore-line method.nonObject (the test intentionally exercises a runtime value that PHPStan cannot prove is an object)
        $nextYear = $resultMatch['nextYear']->customSortValues($closureSort); // @phpstan-ignore-line method.nonObject (the test intentionally exercises a runtime value that PHPStan cannot prove is an object)
    ...
    public function testFillWithDefaultsException(): void
    {
        $this->expectException(\InvalidArgumentException::class);
    ...
    public function testFilter(): void
    {
        ...
        $under = A::create([0 => 1, 1 => 2, 2 => 3, 3 => 4, 7 => 7])->filter(
            ...
            static function ($key, $value): bool {
                return ($value % 2 !== 0) && ($key & 2 !== 0); // @phpstan-ignore-line notIdentical.alwaysTrue (the runtime assertion documents behavior for values broader than this statically narrowed fixture)
            },
    ...
    public function testFilterBy(): void
    {
        ...
        static::assertSame(2365, $b[0]['value']); // @phpstan-ignore-line offsetAccess.notFound (the test intentionally exercises dynamic ArrayAccess keys absent from the inferred fixture shape)
        ...
        /** @noinspection OffsetOperationsInspection */
        static::assertSame('primary', $c[0]['group']); // @phpstan-ignore-line offsetAccess.notFound (the test intentionally exercises dynamic ArrayAccess keys absent from the inferred fixture shape)
        ...
        /** @noinspection OffsetOperationsInspection */
        static::assertSame(1468, $e[0]['value']); // @phpstan-ignore-line offsetAccess.notFound (the test intentionally exercises dynamic ArrayAccess keys absent from the inferred fixture shape)
     ...
     */
    public function testFind($array, $search, $result): void
    {
     ...
     * @param false|mixed $result
     */
    public function testFindKey($array, $search, $result): void
    {
        $closure = static function ($value) use ($search) {
            return $value === $search;
        };
    ...
    public function testFindKeyWithKeyParameter(): void
    {
    ...
    public function testFindKeyForMinAndMaxValues(): void
    {
        $arrayy = A::create([
            3 => 10,
            4 => -5,
    ...
    public function testGetViaDotNotation(): void
    {
     ...
     * @param string $with
     */
    public function testImplode($array, $result, $with = ','): void
    {
     ...
     * @param string $with
     */
    public function testImplodeKeys($array, $result, $with = ','): void
    {
    ...
    public function testIsArrayMultidim(): void
    {
        $testArrays = [
            [1 => [1]],
            [0, 1, 2, 3, 4],
    ...
    public function testIsSequentialRecursive(): void
    {
        $testArrays = [
            [1 => [1]],
            [0, 1, 2, 3, 4],
    ...
    public function testMagicSetViaDotNotation(): void
    {
        $arrayy = new A();
        $arrayy['user'] = ['lastname' => 'Moelleken'];
        $arrayy['user.firstname'] = 'Lars';
    ...
    public function testMapSimpleExample(): void
    {
     ...
     * @param bool  $result
     */
    public function testMatches($array, $search, $result): void
    {
        $arrayy = A::create($array);
    ...
    public function testMatchesAnySimple(): void
    {
        /**
         * @param int   $value
         * @param mixed $key
    ...
    public function testMatchesSimple(): void
    {
        /**
         * @param int   $value
         * @param mixed $key
    ...
    public function testMergeMethods(): void
    {
    ...
    public function testMissingToString(): void
    {
        $this->expectException(\InvalidArgumentException::class);
    ...
    public function testMoveElementToFirstPlace(): void
    {
    ...
    public function testMoveElementToLastPlace(): void
    {
        $arr1 = new A(['a', 'b', 'c', 'd', 'e']);
    ...
    public function testOffsetUnsetViaDotNotation(): void
    {
        ...
        static::assertSame($array, $arrayy->toArray());
        static::assertFalse(isset($array[$offset])); // @phpstan-ignore-line isset.offset, staticMethod.alreadyNarrowedType (the assertion verifies runtime removal even though the fixture shape already excludes the offset)
        static::assertFalse($arrayy->offsetExists($offset));
    }
    ...
    public function testOrderByValueKeepIndex(): void
    {
        $array = [
            100 => 'abc',
            99  => 'aaa',
    ...
    public function testOrderByValueNewIndex(): void
    {
        $array = [
            1   => 'hcd',
            3   => 'bce',
    ...
    public function testPrependKey(): void
    {
        $arrayy = new A(['id' => 999, 'name' => 'flux', 'group' => null, 'value' => 6868, 'when' => '2015-01-01']);
        $arrayyResult = new A(
            [
    ...
    public function testReduceViaFunction(): void
    {
        $testArray = ['foo', 2 => 'bar', 4 => 'lall'];
    ...
    public function testReindexSimple(): void
    {
        $testArray = [2 => 1, 3 => 2];
        $arrayy = new A($testArray);
        $arrayy->reindex();
    ...
    public function testReplaceAllKeys(): void
    {
        $firstArray = [
            1 => 'one',
            2 => 'two',
    ...
    public function testReplaceAllKeysV2(): void
    {
        $firstArray = [
            1 => 'one',
            2 => 'two',
    ...
    public function testReplaceAllValues(): void
    {
        $firstArray = [
            1 => 'one',
            2 => 'two',
        ...
        self::assertImmutable($arrayy, $resultArrayy, $firstArray, $resultArray); // @phpstan-ignore-line argument.type (the runtime API intentionally accepts or transforms a value PHPStan cannot reconcile with the invariant template)
    }

    public function testReplaceAllValuesV2(): void
    {
        $firstArray = [
            1 => 'one',
            2 => 'two',
    ...
    public function testReplaceV2(): void
    {
        $arrayyTmp = A::create([1 => 'foo', 2 => 'foo2', 3 => 'bar']);
     ...
     * @param mixed $value
     */
    public function testSet($array, $key, $value): void
    {
        $arrayy = new A($array);
     ...
     * @param mixed $value
     */
    public function testSetAndGet($array, $key, $value): void
    {
        $arrayy = new A($array);
    ...
    public function testSetAndGetSimple(): void
    {
        $arrayy = new A([1, 2, 3]);
    ...
    public function testSetV2(): void
    {
    ...
    public function testSetValueViaMagicSet(): void
    {
    ...
    public function testSetViaDotNotation(): void
    {
        $arrayy = new A(['Lars' => ['lastname' => 'Moelleken']]);

        static::assertSame(['lastname' => 'Moelleken'], $arrayy['Lars']->getArray()); // @phpstan-ignore-line method.nonObject (the test intentionally exercises a runtime value that PHPStan cannot prove is an object)
        ...
        static::assertSame('Moelleken', $arrayy['Lars']['lastname']); // @phpstan-ignore-line offsetAccess.notFound (the test intentionally exercises dynamic ArrayAccess keys absent from the inferred fixture shape)
    ...
    public function testSimpleAt(): void
    {
        $result = A::create();
    ...
    public function testSizeIs(): void
    {
        $a = A::create([1, 2]);
    ...
    public function testSizeIsLessThen(): void
    {
        $a = A::create([1, 2]);
    ...
    public function testSizeIsGreaterThan(): void
    {
        $a = A::create([1, 2]);
    ...
    public function testSizeIsBetween(): void
    {
        $a = A::create([1, 2]);
    ...
    public function testSimpleEach(): void
    {
    ...
    public function testSimpleRandom(): void
    {
    ...
    public function testSimpleRandomWeighted(): void
    {
        $testArray = ['foo', 'bar'];
    ...
    public function testSortAscWithPreserveKeys(array $array): void
    {
        ...
        self::assertImmutable($arrayy, $resultArrayy, $array, $resultArrayV2->getArray()); // @phpstan-ignore-line argument.type (the runtime API intentionally accepts or transforms a value PHPStan cannot reconcile with the invariant template)
    }
    ...
    public function testNatsortImmutable(array $array): void
    {
        ...
        static::assertSame($array, $arrayResult);
        self::assertImmutable($arrayy, $arrayyResult, $array, $arrayResult); // @phpstan-ignore-line argument.type (the runtime API intentionally accepts or transforms a value PHPStan cannot reconcile with the invariant template)
    }
    ...
    public function testCustomMerge(): void
    {
        $arr = [
    ...
    public function testCreateFromObjectAndDot(): void
    {
        $s = new \stdClass();
        $s->foo = 'bar';
    ...
    public function testStaticCreateFromObjectVars(): void
    {
        $a = new \stdClass();
        $a->x = 42;
        $a->y = ['lall', 'foo'];
     ...
     * @param non-empty-string|null $separator
     */
    public function testStaticCreateFromString($string, $separator): void
    {
        if ($separator !== null) {
            $array = \explode($separator, $string);
        } else {
    ...
    public function testUnsetSimple(): void
    {
        $arrayy = new A([1 => 1, 2 => 2, 3 => 3]);
        unset($arrayy[2]);
    ...
    public function testWalkSimple(): void
    {
        $callable = static function (&$value, $key) {
            $value = $key;
        };
    ...
    public function testWalkSimpleRecursively(): void
    {
        $callable = static function (&$value, $key) {
            $value = $key;
        };
